...
class StudentLastMarksListVC: UIViewController, ItemsBarDelegate  {
    ...
    private func setupPageViewController() {
        let homeworkListVC = HomeworkListViewController(performanceAPI: performanceAPI, quater: quater, subjectId: subjectId, hasDetails: true)
        let classworkListVC = ClassworkListViewController(performanceAPI: performanceAPI, quater: quater, subjectId: subjectId, hasDetails: false)
