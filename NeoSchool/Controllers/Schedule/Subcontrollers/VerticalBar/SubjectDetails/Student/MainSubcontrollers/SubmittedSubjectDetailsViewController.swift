...
class SubmittedSubjectDetailsViewController: SubjectDetailsViewController, Notifiable, Confirmable {
    ...
    @objc private func cancelSubmission() {
        self.showConfirmView(
            ...
            text: "Отмените отправку, если хотите прикрепить другие файлы. После этого не забудьте повторно сдать задание",
            confirmButtonText: "Отменить отправку",
            declineButtonText: "Не отменять",
