...
class ChangePasswordViewController: DetailViewController, Confirmable, UITextFieldDelegate {
    ...
    private lazy var currentPasswordInputView: AlertPasswordInputView = {
        let input = AlertPasswordInputView(placeholder: "Текущий пароль", hintText: "Текущий пароль введен неверно", isHintHidden: true)
    ...
    private func areAllInputsValid() -> Bool {
        if let text0 = currentPasswordInputView.inputTextField.text, !text0.isEmpty,
    ...
    private func arePasswordsValid() -> Bool {
        ...
        guard passwrod != "", confirmPassword != "", currentPassword != "" else { return false }
