...
class ProfileInfoView: ContainerView {
    ...
    private func setupUI() {
        ...
        [
            userTitleLabel, FIOTitleLabel, userFullName, emailTitleLabel, userEmail, lineImage, schoolTitleLabel,
            schoolNameTitleLabel, schoolNameLabel, mainClassTitleLabel, mainClassLabel, otherInfoTitleLabel, otherInfoLabel,
        ]
